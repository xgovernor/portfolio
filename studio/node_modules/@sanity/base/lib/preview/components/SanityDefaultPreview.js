...
class SanityDefaultPreview extends _react.default.PureComponent {
  constructor() {
    ...
    _defineProperty(this, "resolveMedia", () => {
      ...
      if (isRecord(value.media) && value.media._type === 'reference' && value.media._ref && (0, _assetUtils.isImageSource)(media)) {
      ...
      if (isRecord(media) && media.asset && (0, _assetUtils.isImageSource)(media)) {
        return this.renderMedia;
