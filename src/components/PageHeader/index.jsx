...
function PageHeader({ data }) {
  return (
    <section className="">
      <Container className="max-md:min-h-[60vh] max-md:h-auto max-md:flex max-md:flex-col max-md:justify-end max-md:px-[30px] max-md:pt-24 max-md:pb-[40px] md:max-xl:pt-[100px] md:max-lg:pb-[80px] md:max-lg:px-[92px] lg:max-xl:pb-[100px]  lg:max-xl:px-[150px] xl:max-w-[972px] xl:pt-[120px] xl:pb-[110px]">
