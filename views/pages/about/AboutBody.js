            ...
            <section className="p_about_body_info">
                ...
                <Container>
                    ...
                    <div className='p_about_info_card'>
                        ...
                        {/* Right Side */}
                        <div className='p_card_right'>
                            <p className='p_body'>I then worked with various people/agencies. During these years, in addition to great mentors and orders, a highlight was Muhammad Abdullah, for whom I was allowed to be a web developer myself. We still work together today on various freelance projects, but Abdullah has long been in the fast lane.</p>
                        </div>
                    </div>
                    ...
                    <div className='p_about_info_card'>
                        ...
                        {/* Right Side */}
                        <div className='p_card_right'>
                            <p className='p_body'>In addition to workload, I enjoy attending webinars and meetings on web design and development or helping out my buddies by solving their problems on the Discord server.</p>
                        </div>
                    </div>
                        ...
                        <div className='p_card_right'>
                            <table className='p_table'>
                                <tbody>
                                    <tr>
                                        <td className="__left">
                                            <p className="p_body">Junior Web Developer</p>
                                        </td>
                                    ...
                                    <tr>
                                        <td className="__left">
                                            <p className="p_body">Freelance Developer</p>
                                        </td>
                                        <td className="__center">
