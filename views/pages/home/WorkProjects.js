					...
					<div className="p_projects_card">
						<Container>
							<div className="p_card_left">
								...
								<p className="p_body">
									The Gisthive is a multidisciplinary science journal. An
									innovative place to study and learn about science & its facts.
									The Gisthive publishes works of enthusiastic people & welcomes
									Bengali readers from all over the world.
									<br />
									<br />
									<strong>Technologies: </strong>
									Next.JS, SASS, Sanity, Vercel, Figma(for UI/UX)
								</p>
					...
					<div className="p_projects_card">
						<Container>
							<div className="p_card_left">
								...
								<Link href={`https://islamerkantho.com`}>
									<a className="p_link" target="_blank">
										Comming soon
									</a>
								</Link>
